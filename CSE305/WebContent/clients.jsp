		...
		<div class="row">
			<div class="col-sm-6">
				...
				<form action="add_client" method="post">
					...
					<div class="form-group">
						<label for="cc">Credit Card: </label> <input type="number"
							name="cc" id="cc" />
					</div>
				...
				<tbody>
					<c:forEach items="${requestScope.clients}" var="client">
						<tr>
							...
							<td><a href="edit_client?id=${client.id}">Edit</a></td>
							<c:if test="${sessionScope.role eq 'Manager'}">
								<td><a href="delete_user?id=${client.id}&type=client">Delete</a></td>
							</c:if>
						</tr>
					</c:forEach>
				</tbody>
